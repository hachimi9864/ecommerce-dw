...
-- ============================================================
-- 加分思考（可以不做，面试时口头说）：
-- - 次日留存率：第N天活跃用户中，第N+1天还活跃的占比
--   思路：dws_user_day 自连接 a.user_id=b.user_id AND a.dt+1=b.dt
-- - 商品"加购未买"榜：cart多但buy少 → 可能是价格敏感，适合发券
--   思路：同一张 dws_item_day 里 cart_cnt 高 buy_cnt 低，按差值排序
-- ============================================================
